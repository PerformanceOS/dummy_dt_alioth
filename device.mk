...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/wifi/wpa_supplicant.conf.meta_module:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/wpa_supplicant.conf.meta_module \
    $(LOCAL_PATH)/configs/wifi/wpa_supplicant.conf.txt:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/wpa_supplicant.conf.txt \
